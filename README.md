...
- Redis_Cluster - Works 100%, just make sure to:
    ...
    2) Use above and append the output to appropriately with command: `kubectl exec -it redis-cluster-0 -- redis-cli --cluster create --cluster-replicas 1 <STEP 1 OUTPUT>`
